  ...
  class TopicInfo : public tinyros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 1) = (this->topic_id >> (8 * 1)) & 0xFF;
      ...
      uint32_t length_topic_name = strlen(this->topic_name.c_str());
      varToArr(outbuffer + offset, length_topic_name);
      offset += 4;
      memcpy(outbuffer + offset, this->topic_name.c_str(), length_topic_name);
      offset += length_topic_name;
      uint32_t length_message_type = strlen(this->message_type.c_str());
      varToArr(outbuffer + offset, length_message_type);
      offset += 4;
      memcpy(outbuffer + offset, this->message_type.c_str(), length_message_type);
      offset += length_message_type;
      uint32_t length_md5sum = strlen(this->md5sum.c_str());
    ...
    virtual const char * getType(){ return "tinyros_msgs/TopicInfo"; }
    virtual const char * getMD5(){ return "033d42208826b52fde17cbe06f6e856c"; }
