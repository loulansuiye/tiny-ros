  ...
  class Log : public tinyros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->level >> (8 * 0)) & 0xFF;
      ...
      uint32_t length_msg = strlen(this->msg.c_str());
    ...
    virtual const char * getType(){ return "tinyros_msgs/Log"; }
    virtual const char * getMD5(){ return "0bd74339b4d77cb15766d831a3d15eeb"; }
