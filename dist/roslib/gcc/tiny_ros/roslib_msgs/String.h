...
namespace roslib_msgs
{
  ...
  class String : public tinyros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_data = strlen(this->data.c_str());
    ...
    virtual const char * getType(){ return "roslib_msgs/String"; }
    virtual const char * getMD5(){ return "5803b93aeb3e71858cec3497cca77163"; }
