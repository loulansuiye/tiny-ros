...
static const char TEST[] = "tinyros_hello/Test";
  ...
  class TestRequest : public tinyros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->__id__ >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_input = strlen(this->input.c_str());
    ...
    virtual const char * getMD5(){ return "26ee7a44335f1f7b55a5a7490460807d"; }
  ...
  class TestResponse : public tinyros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->__id__ >> (8 * 3)) & 0xFF;
      offset += sizeof(this->__id__);
      uint32_t length_output = strlen(this->output.c_str());
    ...
    virtual const char * getType(){ return TEST; }
    virtual const char * getMD5(){ return "e2f6296e6ea9df7406f4fac9fb52d44b"; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
