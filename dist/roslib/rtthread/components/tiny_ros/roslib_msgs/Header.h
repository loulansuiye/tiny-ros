  ...
  class Header : public tinyros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->stamp.nsec >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_frame_id = strlen(this->frame_id.c_str());
    ...
    virtual const char * getType(){ return "roslib_msgs/Header"; }
    virtual const char * getMD5(){ return "a4a17e29b1585e34437f51ffa30904c5"; }
